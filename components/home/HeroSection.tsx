    ...
    return (
        <section className="relative bg-background pt-8 pb-0 md:pt-12 overflow-hidden">
            <div className="page-container flex flex-col items-center text-center z-10 relative">
                    ...
                    <div className="flex gap-4 justify-center pt-4">
                        <Button className="bg-black text-white hover:bg-black/90 h-12 px-6 rounded-lg gap-2">
                            <span className="text-xs text-left leading-tight">
                                GET IT ON <br /> <span className="text-base font-bold">Google Play</span>
                            </span>
                        </Button>
                        <Button className="bg-black text-white hover:bg-black/90 h-12 px-6 rounded-lg gap-2">
                            <span className="text-xs text-left leading-tight">
                                Download on the <br /> <span className="text-base font-bold">App Store</span>
                            </span>
                        </Button>
                    </div>
                </div>
                ...
                {/* Hero Images Layout */}
                <div className="relative w-full max-w-6xl mx-auto flex justify-center items-end mt-4 md:mt-8 min-h-[300px] md:min-h-[500px]">

                    {/* Expert 1 (Left) */}
                    <div className="hidden md:block absolute left-0 bottom-0 w-[250px] lg:w-[350px] transition-transform hover:scale-105 duration-500">
                        <Image
                    ...
                    {!hidePhone && (
                        <div className="relative z-20 w-[280px] md:w-[340px] lg:w-[500px] mb-4 md:-mb-8 transition-transform hover:-translate-y-2 duration-500">
                    ...
                    {/* Expert 2 (Right) */}
                    <div className="hidden md:block absolute right-0 bottom-0 w-[250px] lg:w-[350px] transition-transform hover:scale-105 duration-500">
                        <Image
